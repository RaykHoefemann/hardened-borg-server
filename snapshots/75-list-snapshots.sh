...
#
#   <client>  Required. A username as it appears under HOST_REPO_BASE, and
#             therefore as the top-level directory this script looks for
#             under SNAPSHOT_BASE. Not cross-checked against clients.conf or
