...
Its design focuses above all on security, privacy, and data integrity.
...
This document is structured around three core chapters, one per focus — **Security** (Chapter 1), **Privacy** (Chapter 2), and **Data Integrity** (Chapter 3) — followed by general feature, architecture, and configuration documentation.
